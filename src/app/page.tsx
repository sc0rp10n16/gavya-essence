...
const perks = [
  {
    ...
    description: "Get your product delivered to you within a week.",
  },
  {
  ...
  },
  {
    ...
    Icon: Leaf,
    description:
      "We've pledge 10% of our sales to the preservation and restoration of the natural environment.",
  },
];
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to Gavya Essence. Every product on our platform is verified
